...
export class UserFeedbackComponent implements OnInit {
  ...
  public onSubmit(): void {
    this.ratingByUser = new ReviewModel(sessionStorage.getItem('email'),
    this.data.giftId, this.feedbackForm.get('rating').value,
    this.feedbackForm.get('comment').value, Date.now().toString());
